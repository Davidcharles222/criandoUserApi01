...
router.put('/user',UserController.edit,AdminAuth);/*19º metodo put para atualizar usuário da pagina UserController.edit*/
router.delete('/user/:id',UserController.remove,AdminAuth)/*22º metodo delete para deletar usuário do id mencionado na pagina UserController.remove */
